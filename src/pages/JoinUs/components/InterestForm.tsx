            ...
            <AnimatePresence mode="wait">
              {submitted ? (
                ...
                >
                  ...
                  <h3 className="mt-4 font-display text-xl font-bold text-charcoal">Thanks for your interest!</h3>
                ...
                >
                  <div>
                    ...
                    />
                    {errors.name && <p id="name-error" role="alert" className="mt-1.5 font-body text-xs text-tomato">{errors.name}</p>}
                  </div>
                  <div>
