...
import storeImg from "../../../assets/images/locations/inline.jpg";
...
export function MenuCTA() {
  return (
    <section className={`${containerClasses} py-16 sm:py-20 lg:py-24`}>
      ...
      >
        <div className="flex flex-col items-center px-4 py-4 sm:items-start sm:px-4 sm:py-0">
          ...
          <p className="mt-2 font-body text-base text-white/90">Go ahead. Order now.</p>
          <Link
            to="/#hero"
        ...
        <img
          ...
          alt=""
          aria-hidden="true"
          className="h-56 w-full rounded-2xl object-cover sm:h-64 sm:w-2/5 lg:h-72"
        />
      </motion.div>
    </section>
  );
