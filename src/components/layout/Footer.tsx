  ...
  return (
    <footer className="bg-charcoal py-10 text-cream/60">
      <div className={`${containerClasses} flex flex-col items-center gap-4 text-center sm:flex-row sm:justify-between sm:text-left`}>
        ...
        <p className="font-display text-sm font-semibold uppercase tracking-[0.2em] text-cream/70">
          Every slice leaves you wanting one more.
        </p>
        <Link
          to="/about"
          className="group relative py-1 font-display text-base font-semibold uppercase tracking-wide text-cream/70 transition-colors duration-150 ease-in-out hover:text-orange"
        >
          About Us
          <span
