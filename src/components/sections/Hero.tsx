  ...
  return (
    ...
    >
      <div className={`${containerClasses} bg-blue grid grid-cols-1 items-center gap-8 lg:grid-cols-[1.1fr_1fr] lg:gap-16`}>
        ...
        >
          <p className="hidden font-display text-base font-semibold text-charcoal/50 lg:block lg:text-lg">
            Every slice leaves you wanting one more.
          </p>
          <Logo variant="plain" className="hidden lg:mt-2 lg:block lg:h-56 xl:h-64" />
          ...
          <div className="mt-8 flex flex-col items-center gap-4 sm:flex-row sm:justify-center lg:justify-start">
            <Button href="#personality" variant="primary" className="w-full sm:w-auto">
              See the Slice
            </Button>
            <Button href="/join-us" variant="secondary" className="w-full sm:w-auto">
              Join the Brand
            </Button>
          </div>
        </motion.div>
        ...
        <div className="relative order-2 mx-auto flex aspect-square w-full max-w-[16rem] items-center justify-center sm:max-w-[19rem] lg:order-2 lg:max-w-[24rem] xl:max-w-[27rem]">
          {/* Grounding shadow */}
